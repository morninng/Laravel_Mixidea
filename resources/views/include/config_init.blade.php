<script type="text/javascript">
	...
	var hangout_NA_id = "{{ $mixidea_app_config['hangout_NA_id'] }}";
	var hangout_Asian_id = "{{ $mixidea_app_config['hangout_Asian_id'] }}";
	var hangout_BP_id = "{{ $mixidea_app_config['hangout_BP_id'] }}";
</script>
